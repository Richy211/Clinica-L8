...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="http://localhost:8000/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="http://localhost:8000/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
 ...
 <!-- DataTables -->
 <link rel="stylesheet" href="http://localhost:8000/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
 <link rel="stylesheet" href="http://localhost:8000/bower_components/datatables.net-bs/css/dataTables.bootstrap.css">
...
<!-- Select 2 -->
<link rel="stylesheet" href="http://localhost:8000/bower_components/select2/dist/css/select2.min.css">
...
<!-- Morris.js charts -->
<script src="http://localhost:8000/bower_components/raphael/raphael.min.js"></script>
<script src="http://localhost:8000/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="http://localhost:8000/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jQuery Knob Chart -->
<script src="http://localhost:8000/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
...
<!-- DataTables -->
<script src="http://localhost:8000/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>

<script src="http://localhost:8000/bower_components/datatables.net-bs/js/dataTables.responsive.min.js"></script>

<script src="http://localhost:8000/bower_components/datatables.net/js/dataTables.bootstrap.min.js"></script>

<!-- FullCalendar -->

<script src="http://localhost:8000/bower_components/fullcalendar/dist/fullcalendar.min.js"></script>
<script src="http://localhost:8000/bower_components/fullcalendar/dist/locale/es.js"></script>
<script src="http://localhost:8000/bower_components/moment/moment.js"></script>

<!-- Select2 -->
<script src="http://localhost:8000/bower_components/select2/dist/js/select2.js"></script>
...
<script type="text/javascript">
  ...
  $(".table").DataTable({
    ...
    "language": {
      ...
      "sInfoEmpty": "Mostrando registros del = al = de un total de 0",
      "oPaginate": {
