        ...
        @if($horarios == null)
            ...
            @if(auth()->user()->rol == "Doctor")
                ...
                <form method="post" action="{{ url('Horario') }}">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            Desde <input type="time" class="form-control" name="horarioInicio">
                        </div>

                        <div class="col-md-2">
                            Hasta <input type="time" class="form-control" name="horarioFin">
                        </div>
            ...
            @foreach($horarios as $hora)
                ...
                @if(auth()->user()->rol == "Doctor")
                    ...
                    <form method="post" action="{{ url('editar-horario/'.$hora->id) }}">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                Desde <input type="time" class="form-control" name="horarioInicio" value="{{ $hora->horarioInicio }}">
                            </div>

                            <div class="col-md-2">
                                Hasta <input type="time" class="form-control" name="horarioFin" value="{{ $hora->horarioFin}}">
                            </div>
