...
@section('content')
        ...
        <div class="content-wrapper">
            ...
            <div class="box-header">
                <button class="btn btn-primary" data-toggle="modal" data-target="#CrearSecretaria">Secretaria</button>
            </div>
                        ...
                        <tbody>
                            @foreach($secretarias as $secretaria)
                                <tr>
                                    ...
                                    @if($secretaria->documento != "documento")
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                <div class="form-group">
                                    <h2>Nombre y Apellido</h2>
                                        <input type="text" class="form-control input-lg" name="name"  
                                        required value="{{ $secretaria->name }}">
                                </div>

                                <div class="form-group">
                                    <h2>Email</h2>
                                        <input type="email" class="form-control input-lg" name="email"  
                                        required value="{{ $secretaria->email }}">
                                ...
                                <div class="form-group">
                                    <h2>Nueva Contraseña</h2>
                                        <input type="text" class="form-control input-lg" name="passwordN"  required value="">
