...
class CitasController extends Controller
{
    ...
    public function HorariosDoctor(Request $request)
    {
        $datos = request();

        DB::table('horarios')->insert(['id_doctor' => auth()->user()->id, 'horarioInicio' => $datos["horarioInicio"], 'horarioFin' => $datos["horarioFin"]]);
    ...
    public function EditarHorario(Request $request)
    {
       ...
       /*  dd($datos['id']); */
        ...
        DB::table('horarios')->where('id', $datos['id'])->update(['horarioInicio' => $datos["horarioInicio"], 'horarioFin' => $datos["horarioFin"]]);
        return redirect('Citas/'.auth()->user()->id);
    }
